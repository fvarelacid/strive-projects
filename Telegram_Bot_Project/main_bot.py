...
sys.path.append("/Users/franciscovarelacid/Desktop/Strive/strive-projects/Telegram_Bot_Project/handgestures")

with open('static/config.json', 'r') as f:
 token = json.load(f)

# bot = telegram.Bot(token=token["telegramToken"])
...
def photo(message):
    ...
    img = transform_single_image("/Users/fvarelacid/Desktop/Strive/strive-projects/Telegram_Bot_Project/images/image.jpg")
